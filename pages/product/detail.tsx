...
// 									<Typography className={'title-main'}>{product?.productDetail}</Typography>
// 									<Stack className={'top-box'}>
// 										<Typography className={'city'}>{product?.productDiscount}</Typography>
...
// 											<img src="/img/icons/bed.svg" alt="" /> <Typography>{product?.productDiscount} bed</Typography>
// 										</Stack>
// 										<Stack className="option">
// 											<img src="/img/icons/room.svg" alt="" /> <Typography>{product?.productSoldCount} room</Typography>
// 										</Stack>
// 										<Stack className="option">
// 											<img src="/img/icons/expand.svg" alt="" /> <Typography>{product?.productPrice} m2</Typography>
// 										</Stack>
// 									</Stack>
// 								</Stack>
...
// 											<Typography className={'option-data'}>{product?.productLeftCount}</Typography>
// 										</Stack>
// 									</Stack>
// 									<Stack className={'option'}>
// 										<Stack className={'svg-box'}>
...
// 											<Typography className={'option-data'}>{product?.productSoldCount}</Typography>
// 										</Stack>
// 									</Stack>
// 									<Stack className={'option'}>
// 										<Stack className={'svg-box'}>
...
// 											<Typography className={'option-data'}>{product?.productVolume} m2</Typography>
// 										</Stack>
// 									</Stack>
// 									<Stack className={'option'}>
// 										<Stack className={'svg-box'}>
...
// 											<Typography className={'option-data'}>{product?.productCollection}</Typography>
// 										</Stack>
// 									</Stack>
// 								</Stack>
